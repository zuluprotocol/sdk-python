...
_LISTDELEGATIONSREQUEST = _descriptor.Descriptor(
  ...
  full_name='vega.coreapi.v1.ListDelegationsRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='party', full_name='vega.coreapi.v1.ListDelegationsRequest.party', index=0,
      number=1, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, json_name='party', file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='node', full_name='vega.coreapi.v1.ListDelegationsRequest.node', index=1,
      number=2, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
    ...
    _descriptor.FieldDescriptor(
      name='epoch_seq', full_name='vega.coreapi.v1.ListDelegationsRequest.epoch_seq', index=2,
      number=3, type=9, cpp_type=9, label=1,
      has_default_value=False, default_value=b"".decode('utf-8'),
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_LISTDELEGATIONSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='vega.coreapi.v1.ListDelegationsResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='delegations', full_name='vega.coreapi.v1.ListDelegationsResponse.delegations', index=0,
      number=1, type=11, cpp_type=10, label=3,
      has_default_value=False, default_value=[],
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
Account = _reflection.GeneratedProtocolMessageType('Account', (_message.Message,), {
  'DESCRIPTOR' : _ACCOUNT,
  '__module__' : 'vega.coreapi.v1.coreapi_pb2'
...
ListDelegationsRequest = _reflection.GeneratedProtocolMessageType('ListDelegationsRequest', (_message.Message,), {
  ...
  '__module__' : 'vega.coreapi.v1.coreapi_pb2'
  # @@protoc_insertion_point(class_scope:vega.coreapi.v1.ListDelegationsRequest)
  })
...
ListDelegationsResponse = _reflection.GeneratedProtocolMessageType('ListDelegationsResponse', (_message.Message,), {
  ...
  '__module__' : 'vega.coreapi.v1.coreapi_pb2'
  # @@protoc_insertion_point(class_scope:vega.coreapi.v1.ListDelegationsResponse)
  })
...
_COREAPISERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='vega.coreapi.v1.CoreApiService.ListDelegations',
    index=10,
    containing_service=None,
