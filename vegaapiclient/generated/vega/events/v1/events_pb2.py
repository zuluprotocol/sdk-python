...
_BUSEVENT = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      name='version', full_name='vega.events.v1.BusEvent.version', index=39,
